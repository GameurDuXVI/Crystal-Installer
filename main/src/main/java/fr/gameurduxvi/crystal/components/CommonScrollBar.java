...
public class CommonScrollBar extends JScrollPane {
    ...
    public CommonScrollBar(Component view) {
        this(view, VERTICAL_SCROLLBAR_AS_NEEDED, HORIZONTAL_SCROLLBAR_AS_NEEDED);
    }

    public CommonScrollBar(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy);
    }

    public CommonScrollBar(Component view, int vsbPolicy, int hsbPolicy) {
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        public ModernScrollBarUI(CommonScrollBar sp) {
            this.sp = sp;
        }
